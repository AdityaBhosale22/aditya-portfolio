...
const socialLinks = [
  { name: 'GitHub', url: 'https://github.com/AdityaBhosale22', icon: Github, color: '#FFFFFF' },
  { name: 'LinkedIn', url: 'https://linkedin.com/in/adityabhosale22', icon: Linkedin, color: '#0A66C2' },
  { name: 'Twitter', url: 'https://twitter.com/adityyaxb', icon: Twitter, color: '#1DA1F2' },
  { name: 'Email', url: 'mailto:adityabhosale4388@gmail.com', icon: Mail, color: '#30D158' },
];
