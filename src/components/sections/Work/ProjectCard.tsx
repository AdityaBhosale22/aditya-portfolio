...
const ProjectCard = memo(function ProjectCard({ project, index }: ProjectCardProps) {
  ...
  const projectSchema = useMemo(() => ({
    ...
    "author": {
      "@type": "Person",
      "name": "Aditya",
      "url": "https://adityabhosale.com"
    },
    "image": `https://adityabhosale.com${project.image}`,
          ...
          <div className="relative h-[32vh] xs:h-[36vh] sm:h-[40vh] md:h-[45vh] lg:h-[55vh] xl:h-[60vh] rounded-xl md:rounded-2xl overflow-visible">
            ...
            >
              ...
              <div className="absolute inset-0 m-[3px] rounded-[9px] md:rounded-[13px] overflow-hidden bg-[#171616] z-[1]">
                <Image
                  src={project.image}
                  alt={`${project.title} - Aditya Project Screenshot`}
                  fill
            ...
            >
              ...
              <div className="absolute inset-0 m-[3px] rounded-[9px] md:rounded-[13px] overflow-hidden bg-[#171616] z-[1]">
                <Image
                  ...
                  alt={`${project.title} - Aditya Project Interface`}
                  fill
                  sizes="(max-width: 768px) 100vw, 50vw"
                  className="object-contain md:object-cover"
                  loading="lazy"
          ...
          >
            {project.liveUrl && (
              <Button
                ...
                aria-label={`${project.liveLabel || 'View Live'} for ${project.title}`}
            ...
            {project.githubUrl && (
              <Button
                ...
                aria-label={`${project.githubLabel || 'Source Code'} for ${project.title}`}
                className="text-[11px] sm:text-xs px-3 sm:px-3.5 py-1.5 whitespace-nowrap"
              >
