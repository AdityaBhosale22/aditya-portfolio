...
export default function Work() {
  ...
  return (
    ...
    >
      {/* SEO Microdata */}
      <meta itemProp="name" content="Featured Projects - Aditya Portfolio" />
      <meta
      ...
      />
      <meta itemProp="author" content="Aditya" />

      {/* Hidden SEO Content */}
      <div className="sr-only">
        <h2>Featured Projects Portfolio - Full Stack & AI Web Development</h2>
        <p>
          Explore a curated collection of production-ready applications built by Aditya
      ...
      <div className="container mx-auto px-4 sm:px-6 mb-12 sm:mb-16 md:mb-20">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            A collection of AI-powered, backend-focused, and production-grade applications showcasing scalable architecture, authentication systems, REST APIs, and modern web technologies.
          </motion.p>
