...
export default function Contact() {
  ...
  return (
    ...
    >
      {/* SEO Microdata */}
      <meta itemProp="name" content="Contact Aditya Bhosale - Full Stack Developer" />
      <meta itemProp="description" content="Get in touch with Aditya Bhosale for full-time opportunities, freelance projects, or collaboration. Available for web development, React, Next.js, and full-stack development projects." />
      ...
      <div className="sr-only">
        <h2>Contact Aditya Bhosale - Full Stack Developer</h2>
        
        <h3>Get in Touch</h3>
        <p>
          Aditya is available for full-time roles, freelance projects, and consulting opportunities. 
        ...
        <ul>
          ...
          <li>API Development - RESTful APIs and backend integrations</li>
