...
const stats: StatItem[] = [
  { value: 6, label: 'Production Projects', suffix: '+', max: 10, icon: CheckCircle2, color: '#FF6B35' },
  { value: 1, label: 'Internship Experience', suffix: '', max: 3, icon: Briefcase, color: '#3B82F6' },
  // Third card shows 'AI' in the center and 'Full-Stack Focused' as the label
  { value: 100, label: 'Full-Stack Focused', suffix: '', max: 100, icon: TrendingUp, color: '#10B981', displayText: 'AI' },
];
    ...
    >
      ...
      <div className="relative w-16 h-16 xs:w-20 xs:h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 mb-2 sm:mb-3">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-1">
          ...
          {displayText ? (
            <div className="text-base xs:text-lg sm:text-xl md:text-2xl font-bold text-white leading-tight">
              {displayText}
            </div>
          ) : (
