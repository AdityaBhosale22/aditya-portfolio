...
const services: ServiceCard[] = [
  ...
  },
  {
    ...
    description:
      'Building polished product interfaces with clean motion and responsive layouts.',
  ...
  },
  {
    ...
    description:
      'Building SaaS products with auth, analytics, and scalable workflows.',
    image: '/images/Stack cards/jakub-zerdzicki-O3ChbcT94NM-unsplash.jpg',
    skills: ['Next.js', 'PostgreSQL', 'Clerk', 'Tailwind CSS'],
  },
  {
    id: 'api',
    ...
    description:
      'Designing RESTful APIs with clean architecture and secure service boundaries.',
    image: '/images/Stack cards/sebastian-willius-GKCpRs0rcNY-unsplash.jpg',
    skills: ['REST', 'Express.js', 'MongoDB', 'PostgreSQL'],
  },
];
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0">
          <Image
            src={card.image}
            alt={`${card.title} - Aditya's expertise`}
            fill
