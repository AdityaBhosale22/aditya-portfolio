...
import { Briefcase, GraduationCap, Rocket, Award, LucideIcon } from 'lucide-react';
import { journeyMilestones } from '../Journey/journey.data';
...
const milestones: Milestone[] = journeyMilestones.map((milestone) => ({
  year: milestone.year,
